...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  if(hadc->Instance==ADC3)
  {
    ...
    PA0/WKUP     ------> ADC3_IN0
    */
    GPIO_InitStruct.Pin = humidite_pot2_Pin|humidite_pot3_Pin|humidite_pot4_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOF, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = humidite_pot1_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(humidite_pot1_GPIO_Port, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==ADC3)
  {
    ...
    PA0/WKUP     ------> ADC3_IN0
    */
    HAL_GPIO_DeInit(GPIOF, humidite_pot2_Pin|humidite_pot3_Pin|humidite_pot4_Pin);

    HAL_GPIO_DeInit(humidite_pot1_GPIO_Port, humidite_pot1_Pin);
